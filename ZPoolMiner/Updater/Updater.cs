    ...
    public static class Updater
    {
        ...
        public static double GetGITHUBVersion()
        {
            ...
            if (r1 != null & !r1.Contains("(404)"))
            {
                try
                {
                    ...
                    Form_Main.miners_url = "https://github.com/angelbbs/ZPoolMinerLegacy/releases/download/Fork_Fix_" + Form_Main.githubVersion + "/miners.zip";
        ...
        public static string GetGitAPIData(string URL, string host)
        {
            ...
            try
            {
                ...
                WR.UserAgent = "MinerLegacyForkFix/" + Application.ProductVersion;
                WR.Timeout = 10 * 1000;
