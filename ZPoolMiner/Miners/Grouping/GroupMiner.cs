...
namespace ZPoolMiner.Miners.Grouping
{
    public class GroupMiner
    {
            ...
            if (miningPairs.Count > 0)
            {
                ...
                // init miner
                {
                    ...
                    if (Miner != null)
                    {
                        ...
                        AlgorithmType = mPair.Algorithm.PrimaryAlgorithmPoolID;
                        DualAlgorithmType = mPair.Algorithm.DualZPoolID;
        ...
        public void Start(string wallet, string ID, string password)
        {
            if (Miner.IsRunning)
            {
                return;
            ...
            Miner.Start(wallet, ID, password);
            Thread.Sleep(Math.Max(ConfigManager.GeneralConfig.MinerRestartDelayMS, 500));
        }
    }
}
