...
namespace ZPoolMiner.Miners
{
    public class trex : Miner
    {
        ...
        private string GetServer(string algo)
        {
            ...
            try
            {
                ...
                string serverUrl = Form_Main.regionList[ConfigManager.GeneralConfig.ServiceLocation].RegionLocation +
                    "mine.zpool.ca";
                ret = " -o " + Links.CheckDNS(algo + serverUrl).Replace("stratum+tcp://", "stratum2+ssl://") + ":" + _a.ssl_port.ToString();
            }
            catch (Exception ex)
            {
        ...
        */
        ...
        {
            var commandLine = "";
            string logFile = algorithm.PrimaryAlgorithmPoolID.ToString() + GetLogFileName();
            ...
            if (algorithm.PrimaryAlgorithmPoolID.Equals(AlgorithmType.X16RV2))
            {
            ...
            if (algorithm.PrimaryAlgorithmPoolID.Equals(AlgorithmType.X21S))
            {
            ...
            if (algorithm.PrimaryAlgorithmPoolID.Equals(AlgorithmType.X25X))
            {
