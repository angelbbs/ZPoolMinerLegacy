...
namespace ZPoolMiner.Miners
{
    public class Rigel : Miner
    {
        ...
        public override void Start(string wallet, string ID, string password)
        {
            ...
            LastCommandLine = GetStartCommand(url, wallet, ID, password);
        ...
        private string GetStartCommand(string url, string wallet, string ID, string password)
        {
            ...
            else //dual
            {
                ...
                string coin2 = password.Split(',')[2].Replace("zap=", "").Split('+')[1];

                string password1 = password.Replace("zap=" + coin1 + "+" + coin2, "zap=" + coin1);
                string password2 = password.Replace("zap=" + coin1 + "+" + coin2, "zap=" + coin2);
