    ...
    static class Program
    {
        ...
        static void Main(string[] argv)
        {
            ...
            if (startProgram)
            {
                ...
                if (Configs.ConfigManager.GeneralConfig.ForkFixVersion < 3.0 ||
                    !ConfigManager.GeneralConfig.Platform.Equals("ZPool"))
                {
                    Helpers.ConsolePrint("MinerLegacy", "Previous version: " + Configs.ConfigManager.GeneralConfig.ForkFixVersion.ToString());
                    ConfigManager.GeneralConfig.Platform = "ZPool";
                    ConfigManager.GeneralConfig.ForkFixVersion = 3.0;
                    //ConfigManager.GeneralConfig.EnableProxy = true;
                    try
                    {
                        if (File.Exists("Help\\history.txt"))
                ...
                if (Configs.ConfigManager.GeneralConfig.ForkFixVersion < 4.0 ||
                    !ConfigManager.GeneralConfig.Platform.Equals("ZPool"))
                {
                    Helpers.ConsolePrint("MinerLegacy", "Previous version: " + Configs.ConfigManager.GeneralConfig.ForkFixVersion.ToString());
                    ConfigManager.GeneralConfig.Platform = "ZPool";
                    ConfigManager.GeneralConfig.ForkFixVersion = 4.0;
                    try
                    {
                        if (File.Exists("Help\\history.txt"))
                        {
                ...
                if (Configs.ConfigManager.GeneralConfig.ForkFixVersion < 5.0 ||
                    !ConfigManager.GeneralConfig.Platform.Equals("ZPool"))
                {
                    Helpers.ConsolePrint("MinerLegacy", "Previous version: " + Configs.ConfigManager.GeneralConfig.ForkFixVersion.ToString());
                    ConfigManager.GeneralConfig.Platform = "ZPool";
                    ConfigManager.GeneralConfig.ForkFixVersion = 5.0;
                    try
                    {
                        if (File.Exists("Help\\history.txt"))
                        {
