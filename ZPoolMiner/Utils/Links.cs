...
namespace ZPoolMiner
{
    ...
    {
        public static string VisitUrl = ("https://www.zpool.ca/");
        public static string VisitUrlNew = ("https://github.com/angelbbs/ZPoolMinerLegacy/releases/");
        public static string NhmHelp = ("https://github.com/angelbbs/ZPoolMinerLegacy/");

        public static string PoolStatus = ("https://zpool.ca/api/status");
        public static string WalletBalance = ("https://zpool.ca/api/wallet?address=");
        public static string WalletBalanceEx = ("https://zpool.ca/api/walletEx?address=");
        public static string Currencies = ("https://zpool.ca/api/currencies");
        public static string Blocks = ("https://zpool.ca/api/blocks?coin=");//!!!!!!!!!!!!
        ...
        public static string miningStats = ("https://zpool.ca/wallet/");
        public static string githubReleases = ("https://github.com/angelbbs/ZPoolMinerLegacy/releases");
        public static string githubLatestRelease => CheckDNS("https://api.github.com/repos/angelbbs/ZPoolMinerLegacy/releases/latest");
        ...
        public static string CheckDNS(string domain, bool forceIP = false)
        {
            ...
            try
            {
                ...
                if (_domains is object && _domains != null && _domains.Exists(item => item.domainName == domainName))
                {
