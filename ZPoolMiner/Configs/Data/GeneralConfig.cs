...
namespace ZPoolMiner.Configs.Data
{
    ...
    public class GeneralConfig
    {
        ...
        */
            ...
            private static readonly Color[] ZPoolProfile = { Color.FromArgb(60, 60, 66), Color.White, Color.FromArgb(60, 60, 66), Color.White };
            ...
            private Color[] _ZPoolProfile = MemoryHelper.DeepClone(ZPoolProfile);
            ...
            {
                get => ZPoolProfile;
                set => _ZPoolProfile = MemoryHelper.DeepClone(IsValid(value) ? value : ZPoolProfile);
            }
        }
    }
