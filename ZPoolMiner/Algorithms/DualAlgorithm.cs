...
namespace ZPoolMiner.Algorithms
{
    public class DualAlgorithm : Algorithm
    {
        ...
        /// </summary>
        public override AlgorithmType SecondaryAlgorithmPoolID { get; }
        /// <summary>
        ...
        /// </summary>
        public override AlgorithmType DualZPoolID
        {
            get
            {
                /*
                if (ZPoolID == AlgorithmType.Ethash)
                {
                    switch (SecondaryZPoolID)
                    {
        ...
        public DualAlgorithm(MinerBaseType minerBaseType, AlgorithmType primaryAlgorithmPoolID, AlgorithmType secondaryAlgorithmPoolID, string _DualAlgorithmNameCustom = "WOW!UnknownDualAlgo")
            : base(minerBaseType, primaryAlgorithmPoolID, "")
        {
            SecondaryAlgorithmPoolID = secondaryAlgorithmPoolID;

            AlgorithmName = AlgorithmNames.GetName(DualZPoolID); // needed to add secondary
            SecondaryAlgorithmName = AlgorithmNames.GetName(secondaryAlgorithmPoolID);
        ...
        private void UpdateProfitableIntensity()
        {
            ...
            if (AlgosProfitData.TryGetPaying(PrimaryAlgorithmPoolID, out var paying) |
                AlgosProfitData.TryGetPaying(SecondaryAlgorithmPoolID, out var secPaying))
            {
