    ...
    public class ComputeDevice
    {
        ...
        public static Task<CPUDevice> TryQueryCPUDeviceTask()
        {
            return Task.Run(() =>
            {
                ...
                // get all CPUs
                var cpuCount = CpuUtils.GetCoresCount();
                var name = CpuUtils.GetCpuName().Trim();
        ...
        {
            return GetAlgorithm(modelAlgo.MinerBaseType, modelAlgo.PrimaryAlgorithmPoolID, modelAlgo.SecondaryAlgorithmPoolID);
        }
            ...
            AlgorithmType secondaryAlgorithmType)
        {
            var toSetIndex = AlgorithmSettings.FindIndex(a =>
                a.PrimaryAlgorithmPoolID == algorithmType && a.MinerBaseType == minerBaseType &&
                a.SecondaryAlgorithmPoolID == secondaryAlgorithmType);
        ...
        public void CopyBenchmarkSettingsFrom(ComputeDevice copyBenchCDev)
        {
            foreach (var copyFromAlgo in copyBenchCDev.AlgorithmSettings)
            {
                ...
                if (setAlgo != null)
                {
                    ...
                    ZPoolMiner.Forms.Form_Settings.ActiveForm.Update();
        ...
        public void SetAlgorithmDeviceConfig(DeviceBenchmarkConfig config)
        {
            if (config != null && config.DeviceUUID == Uuid && config.AlgorithmSettings != null)
            {
                ...
                {
                    var setAlgo = GetAlgorithm(conf.MinerBaseType, conf.PrimaryAlgorithmPoolID, conf.SecondaryAlgorithmPoolID);
                    if (setAlgo != null)
                    {
                        ...
                        {
                            if (setAlgo.DualZPoolID == a.DualZPoolID && setAlgo.MinerBaseType == a.MinerBaseType)
                            {
                        ...
                        if (setAlgo is DualAlgorithm dualSA)
                        {
                            ...
                            var dualConf = config.DualAlgorithmSettings?.Find(a =>
                                a.SecondaryAlgorithmID == dualSA.SecondaryAlgorithmPoolID);
                            if (dualConf != null)
                            {
        ...
        public DeviceBenchmarkConfig GetAlgorithmDeviceConfig()
        {
            ...
            foreach (var algo in AlgorithmSettings)
            {
                ...
                var conf = new AlgorithmConfig
                {
                    ...
                    PrimaryAlgorithmPoolID = algo.PrimaryAlgorithmPoolID,
                ...
                {
                    conf.SecondaryAlgorithmPoolID = dualAlgo.SecondaryAlgorithmPoolID;
                    ...
                    {
                        Name = algo.AlgorithmStringID,
                        SecondaryAlgorithmID = dualAlgo.SecondaryAlgorithmPoolID,
        ...
        public List<Algorithm> GetAlgorithmSettings()
        {
            ...
            // sort by algo
            retAlgos.Sort((a_1, a_2) => (a_1.PrimaryAlgorithmPoolID - a_2.PrimaryAlgorithmPoolID) != 0
                ? (a_1.PrimaryAlgorithmPoolID - a_2.PrimaryAlgorithmPoolID)
                : ((a_1.MinerBaseType - a_2.MinerBaseType) != 0
                    ? (a_1.MinerBaseType - a_2.MinerBaseType)
                    : (a_1.SecondaryAlgorithmPoolID - a_2.SecondaryAlgorithmPoolID)));
        ...
        public List<Algorithm> GetAlgorithmSettingsFastest()
        {
            ...
            {
                var algoKey = algo.PrimaryAlgorithmPoolID;
