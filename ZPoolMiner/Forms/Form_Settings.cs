...
namespace ZPoolMiner.Forms
{
    public partial class Form_Settings : Form
    {
        ...
        public Form_Settings()
        {
            ...
            InitializeComponent();
            Icon = Form_Main.MakeTransparentIcon(Properties.Resources.ZPoolIcon2);
            ...
            this.comboBox_ColorProfile.Items.Add("ZPool");
...
//                Enabled = lvi.Checked;
                ...
                if (algorithm is DualAlgorithm dualAlgo)
                {
                    groupBoxSelectedAlgorithmSettings.Text = string.Format(
                    International.GetText("AlgorithmsListView_GroupBox"),
                    $"{algorithm.PrimaryAlgorithmPoolID.ToString() + "+" + algorithm.SecondaryAlgorithmPoolID.ToString() } ({algorithm.MinerBaseTypeName})");
        ...
        private void UpdateSpeedText()
        {
            ...
            var speedString = Helpers.FormatDualSpeedOutput(_currentlySelectedAlgorithm.BenchmarkSpeed, secondarySpeed, 0, _currentlySelectedAlgorithm.PrimaryAlgorithmPoolID, _currentlySelectedAlgorithm.DualZPoolID);
            speedString = speedString.Replace("--", "");
            AlgorithmType algo = AlgorithmType.NONE;
            AlgosProfitData.TryGetPaying(algo, out var payingSec);
            AlgosProfitData.TryGetPaying(_currentlySelectedAlgorithm.PrimaryAlgorithmPoolID, out var paying);
