...
namespace ZPoolMiner.Forms.Components
{
    public partial class GroupProfitControl : UserControl
    {
        ...
        {
            Helpers.ConsolePrint("ForkFixMiner", "Restarting miner by user: " + button_restart.Tag.ToString());
        ...
        private void button_pause_Click(object sender, EventArgs e)
        {
            if (button_pause.Image.Equals(_stopBtn))
            {
                Helpers.ConsolePrint("ForkFixMiner", "Suspend miner by user: " + button_pause.Tag.ToString());
            ...
            if (button_pause.Image.Equals(_runBtn))
            {
                Helpers.ConsolePrint("ForkFixMiner", "Resume miner by user: " + button_pause.Tag.ToString());
