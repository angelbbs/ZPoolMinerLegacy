...
namespace ZPoolMiner.Forms.Components
{
    public partial class WalletsListView : UserControl
    {
        ...
        public void InitLocale()
        {
            ...
            listViewWallets.Columns[2].Text = International.GetText("WalletListView_Wallet");
            listViewWallets.Columns[3].Text = International.GetText("WalletListView_Worker");
        }
        ...
        public void SaveWallets()
        {
            try
            {
                ...
                foreach (ListViewItem lvi in listViewWallets.Items)
                {
                    ...
                    */
                    wallet.Wallet = lvi.SubItems[2].Text;
                    wallet.ID = lvi.SubItems[3].Text;
