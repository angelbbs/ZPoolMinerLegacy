...
namespace ZPoolMiner
{
    ...
    using ZPoolMiner.Devices.Querying;
    using ZPoolMiner.Miners.Grouping;
    ...
    using static ZPoolMiner.Devices.ComputeDeviceManager.Query;
    using static ZPoolMiner.Miners.MinerVersion;
    ...
    {
        public static string platform = "ZPool";
        ...
        public Form_Main()
        {
            ...
            Helpers.ConsolePrint("ZPool", "Start Form_Main");
            switch (ConfigManager.GeneralConfig.ColorProfileIndex)
            {
                ...
                case 13: //tan
                    ...
                    break;
                case 14: //zpool
                    _backColor = ConfigManager.GeneralConfig.ColorProfiles.ZPool[0];
                    _foreColor = ConfigManager.GeneralConfig.ColorProfiles.ZPool[1];
                    _windowColor = ConfigManager.GeneralConfig.ColorProfiles.ZPool[2];
                    _textColor = ConfigManager.GeneralConfig.ColorProfiles.ZPool[3];
                    break;
                default:
                    _backColor = ConfigManager.GeneralConfig.ColorProfiles.DefaultColor[0];
                    _foreColor = ConfigManager.GeneralConfig.ColorProfiles.DefaultColor[1];
            ...
            Helpers.ConsolePrint("ZPool", "Start InitializeComponent");
            ...
            Icon = MakeTransparentIcon(Properties.Resources.ZPoolIcon2);
            Helpers.ConsolePrint("ZPool", "Start InitLocalization");
            ...
            string LCUVer = Convert.ToString(Microsoft.Win32.Registry.GetValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion", "LCUVer", null));
            if (string.IsNullOrEmpty(LCUVer))
            {
                Helpers.ConsolePrint("ZPool", "Windows version " + GetWinVer(Environment.OSVersion.Version) +
            ...
            Helpers.ConsolePrint("ZPool", "Start query RAM");
            ...
            foreach (ManagementObject mo in moc)
            {
                ...
                Helpers.ConsolePrint("ZPool", "Total RAM: " + totalRam + "MB");
                Helpers.ConsolePrint("ZPool", "Page File Size: " + pageFileSize + "MB");
            }
        ...
        public void InitMainConfigGuiData()
        {
            ...
            regionList.Add(region);
            region = new Region();
            region.RegionName = "South East Asia";
            region.RegionLocation = ".sea.";
            regionList.Add(region);
            region = new Region();
            region.RegionName = "Japan";
            region.RegionLocation = ".jp.";
            regionList.Add(region);
        ...
        private void IdleCheck_Tick(object sender, EventArgs e)
        {
            ...
            if (_minerStatsCheck.Enabled)
            {
                if (msIdle < (ConfigManager.GeneralConfig.MinIdleSeconds * 1000) && _isManuallyStarted)
                {
                    ...
                    Helpers.ConsolePrint("ZPool", "Stop from idling mining");
                }
            }
            ...
            if (_minerStatsCheck.Enabled)
            {
                ...
                {
                    StopMining();
                    Helpers.ConsolePrint("ZPool", "Resumed from idling");
                }
            }
            else
            {
                ...
                {
                    Helpers.ConsolePrint("ZPool", "Entering idling state");
        ...
        private void StartupTimer_Tick(object sender, EventArgs e)
        {
            ...
            */
            ...
            _loadingScreen.SetValueAndMsg(30, "Checking server: zpool.ca");
            this.Update();
            this.Refresh();
            Application.DoEvents();
            //****************
            Links.CheckDNS("https://zpool.ca");
            ...
            {
                string domain;
                domain = location.RegionLocation.ToLower().TrimStart('.') + "mine.zpool.ca";
        ...
        private void Form_Main_Shown(object sender, EventArgs e)
        {
            ...
            {
                buttonLogo.Image = Properties.Resources.ZPoolLogo1;
            }
            else
            {
                buttonLogo.Image = Properties.Resources.ZPoolLogo1;
        ...
        private static void ComputeDevicesCheckTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (check > -1 && CheckVideoControllersCount)
            {
                ...
                {
                    Helpers.ConsolePrint("ZPool", "OnGPUsLost.bat error: " + ex.Message);
                }
            }
        ...
        public void ForceMinerStatsUpdate()
        {
            ...
            {
                Helpers.ConsolePrint("ZPool", e.ToString());
            }
        }
        ...
        private void UpdateGlobalRate()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(ZPoolAPIError))
                {
                    ...
                    toolStripStatusLabelBalanceBTCValue.Text = "■ ZPool API Error: " + 
                                                                ZPoolAPIError + " ■  ";
        ...
        public static double GetWinVer(Version ver)
        {
            ...
            */
            int _build = 0;
            string build = Convert.ToString(Microsoft.Win32.Registry.GetValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion", "CurrentBuild", null));
            int.TryParse(build, out _build);
            if (_build >= 22000) return 11;
        ...
        private void Form1_Resize(object sender, EventArgs e)
        {
            ...
            //notifyIcon1.Icon = Properties.Resources.ZPoolIcon;
            notifyIcon1.Icon = Form_Main.MakeTransparentIcon(Properties.Resources.ZPoolIcon);
        ...
        public StartMiningReturnType StartMining(bool showWarnings)
        {
            ...
            if (!showWarnings)
            {
                for (var i = 0; i < 10; i++)
                {
                    ...
                    Helpers.ConsolePrint("ZPool", $"After {i}s has data: {hasData}");
                }
            }
            if (!hasData)
            {
                Helpers.ConsolePrint("ZPool", "No data received within timeout");
                if (showWarnings)
                {
        ...
        private void comboBoxLocation_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                Globals.MiningLocation[Globals.MiningLocation.Length - 1] =
                    regionList[ConfigManager.GeneralConfig.ServiceLocation] + "zpool.ca";
